...
from utils.helpers import try_mkdir, save_molecule_node_csv
...
def interpretation(model, dataloader, args, target_idx):
    model.eval()
    # load pyrenes
    # pyrenes_df = pd.read_csv("/home/maayanfarkash/proj/PBHs-design/compas-3D_pyrenes.csv")
    ...
    # keep only molecules that exist in your dataset
    ...
    for i, name in enumerate(names):
        ...
        #fig_path = f'{dir_name}/interp/{name}.pdf'
